...
const GooglePlaces = [
  ...
  },
  {
    ...
    name: 'Paris',
    image: [pl3],
    description: 'A city of art, culture, and architecture, with stunning landmarks like the Eiffel Tower, the Louvre Museum, and the Tower of London. Paris is home to some of the world’s most iconic landmarks, including the iconic Golden Gate Bridge, the iconic Statue of Liberty, and the',
  ...
  },
  {
    ...
    name: 'Tokyo',
    image: [pl4],
    description: 'A city of culture, art, and history, with stunning landmarks like the Meiji Shrine, the Imperial Palace, and the Tokyo Tower. Tokyo is home to some of the world’s most iconic landmarks, including the iconic Golden Gate Bridge, the iconic Statue of Liberty, and the icon',
